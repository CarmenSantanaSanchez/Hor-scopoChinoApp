...
struct HoroscopoChino{
    ...
    init() {
        ...
        let tigre = Horoscopo (signo: .tigre, desde:"28-01-1998", hasta:"15-02-1999", descripcion: "Rebelde, independiente, dinámico, apasionado, osado, impredecible, impulsivo, sincero, cariñoso, generoso, humanitario, impaciente, imprudente, irascible.")
